...
class Honcho(BaseModel):
    ...
    def get_peers(
        ...
        def fetch_page(page: int = 1, size: int = 50) -> SyncPage[dict[str, Any], Peer]:
    ...
    def __repr__(self) -> str:
        ...
        """
        return f"Honcho(workspace_id='{self.workspace_id}', base_url='{self._http.base_url}')"

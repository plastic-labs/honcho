...
- Authentication can be toggled on/off (`AUTH_USE_AUTH`); under `MULTI_TENANT` it must be on for the API role — the startup validator refuses the combination

"""add_hypothesis_genealogy_tracking

Revision ID: f3b4a250c1fc
Revises: 645b106a7ed2
Create Date: 2026-01-17 04:09:27.984032
...
revision: str = 'f3b4a250c1fc'
down_revision: str | None = '645b106a7ed2'
...
def upgrade() -> None:
    ...
    op.add_column('hypotheses', sa.Column('superseded_by_id', sa.TEXT(), nullable=True))
    op.add_column('hypotheses', sa.Column('supersedes_ids', postgresql.JSONB(astext_type=sa.Text()), server_default=sa.text('NULL'), nullable=True))
    op.create_index(op.f('ix_hypotheses_superseded_by_id'), 'hypotheses', ['superseded_by_id'], unique=False, schema='public')
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_hypotheses_superseded_by_id'), table_name='hypotheses', schema='public')
    op.drop_column('hypotheses', 'supersedes_ids')
    op.drop_column('hypotheses', 'superseded_by_id')

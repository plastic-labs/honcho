...
3. **If you feel strongly about an issue, come to [Discord](http://discord.gg/honcho).**
...
If a PR goes quiet, nudge us in [Discord](http://discord.gg/honcho).

## Reporting bugs and requesting features

Use the [issue templates](https://github.com/plastic-labs/honcho/issues/new/choose). Before
opening one, search existing issues, including closed ones.
...
for how to report one, and note that Honcho does not operate a bug bounty.

...
class QueueManager:
    ...
    async def get_and_claim_work_units(self) -> dict[str, str]:
        ...
        # the trigger-maintained queue_item_batches — one indexed row per pending
        ...
        # sets (zero wasted claims); the batch row locks release at commit,

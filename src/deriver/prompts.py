...
{{
  "explicit": [{{"content": "fact 1"}}, {{"content": "fact 2"}}, {{"content": "fact 3"}}]
}}
The "explicit" field should contain an array of objects, where each object has a "content" field containing one atomic fact.
If no facts are found, return: {{"explicit": []}}
Messages to analyze:
<messages>
{messages}
</messages>

...
- EXPLICIT: "I took my dog for a walk in NYC" → "The peer has a dog", "The peer lives in NYC"
- EXPLICIT: "The peer attended college" + general knowledge → "The peer completed high school or equivalent"
"""
    )

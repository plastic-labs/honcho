...
class TenantCreate(BaseModel):
    # region ai
    # tenant_id is generated by the operator's provisioning system (a control
    # plane in a hosted deployment), never here — honcho only validates shape.
    # RESOURCE_NAME_PATTERN matters beyond hygiene: work-unit
    # keys are `{tenant_id}:{base_key}`, so a tenant id containing ":" would
    # corrupt key parsing fleet-wide.
    # endregion
    tenant_id: Annotated[
        str,

    ...
    *,
    ...
    with (
        ...
        await process_representation_tasks_batch(
            ...
            # Upstream resolves the canonical Session.id from the DB when it is
            # not supplied; these mock messages name a session that does not
            # exist, so hand the id in the way a real queue-driven caller does.

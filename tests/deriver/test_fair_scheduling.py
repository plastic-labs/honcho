...
from tests.deriver.test_queue_item_batches import (  # noqa: F401 -- re-exported fixtures
    SeedWorkUnit,
    _read_batch_keys,
    batch_gate_settings,
    seed_work_unit,
...
class TestThePauseSeam:
    ...
    async def test_an_exclusion_clause_skips_the_paused_tenant_and_nobody_else(
        ...
        def exclude_the_paused_tenant() -> ColumnElement[bool]:
            return models.QueueItemBatch.tenant_id.is_(None) | (
                models.QueueItemBatch.tenant_id != PAUSED_TENANT
            )

...
@pytest.mark.asyncio
async def test_generate_openai(mock_openai_client, mock_openai_response):
...
@pytest.mark.asyncio
async def test_generate_with_system_prompt(mock_anthropic_client, mock_anthropic_response):

...
class TestMainLLMCallFunction:
    ...
    async def test_track_name_names_langfuse_trace_and_generation(self):
        """track_name should name the Langfuse trace + generation per agent and
        stamp provider/model metadata (via propagate_attributes +
        ...
        with (
            ...
            response = await honcho_llm_call(
                ...
                telemetry=LLMTelemetryContext(workspace_name="ws1"),
            )

...
async def test_cache_policy_is_passed_through_extra_params(fake_backend) -> None:
...
async def test_provider_params_are_merged_into_extra_params(fake_backend) -> None:
    config = ModelConfig(

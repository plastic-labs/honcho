...
A native Cordis plugin: memory rides the system-prompt context seam, capture rides the session event feed,
and the model gets `honcho_search`, `honcho_chat`, and `honcho_remember`. `/honcho` shows status.

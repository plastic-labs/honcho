...
See the [Storage API](/api-reference/introduction) to see how to use the data model in practice.
...
<CardGroup cols={2}>
  <Card title="SDK" icon="database" href="/documentation/platform/sdk">

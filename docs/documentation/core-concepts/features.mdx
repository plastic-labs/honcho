...
### Get Context 
Honcho provides intelligent context retrieval, allowing access to a comprehensive Session context object for AI agents.
- The context object includes a relevant Session summary and recent messages.
- Builders can optionally provide a token limit which the entire context must fit into.
---
title: 'Honcho Context Quickstart'
icon: 'bolt'
sidebarTitle: 'Quickstart'
---

Implement Honcho in just a few steps. No signup required.
...
Curating your peer's context window is remarkably simple. The `get_context` method pulls in a mixture of recent messages and messages relevant to the one just sent.

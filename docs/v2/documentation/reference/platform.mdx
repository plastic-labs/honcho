...
Click into any peer to navigate to their respective utilities page. Next to the `Peer` name you can edit the [Peer Configuration](/v2/documentation/features/advanced/reasoning-configuration), and in the tabs below, explore all utilities for the `Peer`.
...
- **Peer configuration and metadata management** including [Session-Peer Configuration](/v2/documentation/features/advanced/reasoning-configuration#session-configuration)

...
One of the primary use cases for streaming in Honcho is with the [chat endpoint](/v2/documentation/features/chat). This allows you to stream the AI's reasoning about a user in real-time.

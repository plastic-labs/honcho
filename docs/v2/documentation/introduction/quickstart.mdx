...
- For production use, [sign up for the managed platform](https://app.honcho.dev) or get an [overview here](v2/documentation/reference/platform).
- For detailed API reference, check out our [SDK documentation](/v2/documentation/reference/sdk).

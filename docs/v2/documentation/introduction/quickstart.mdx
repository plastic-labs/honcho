...
<Tip>📢 **Announcing Honcho Platform**: We've raised $5.35M pre-seed from Variant, White Star Capital & Betaworks to build the personal identity layer for AI!</Tip>
...
- For detailed API reference, check out our [SDK documentation](/documentation/platform/sdk).
- For more examples, explore our [guides](/guides).

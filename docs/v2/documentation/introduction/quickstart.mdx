...
- For production use, [sign up for the managed platform](https://app.honcho.dev) or get an [overview here](../../documentation/reference/platform).
- For detailed API reference, check out our [SDK documentation](../../documentation/reference/sdk).

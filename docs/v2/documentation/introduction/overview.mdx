...
The diagram above shows the flow: agents write messages to Honcho, which triggers reasoning that updates peer representations. Agents can then query those representations to get additional context for their next response.

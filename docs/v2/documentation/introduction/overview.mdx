...
view of a user in the context of a session. Instead of waiting for a LLM to
synthesize an in-context response via the Dialectic endpoint, use this endpoint

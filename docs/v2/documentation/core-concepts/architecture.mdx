...
See the [Storage API](/v2/api-reference/introduction) to see how to use the data model in practice.
...
<CardGroup cols={2}>
  <Card title="SDK" icon="database" href="/v2/documentation/platform/sdk">

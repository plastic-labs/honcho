...
Honcho has a Peer-Centric Architecture: Peers are the most important entity with Honcho with everything revolving around Peers and their representations.

...
Want to skip the manual setup? Import this workflow directly into n8n. In n8n, go to **Workflows** → **Import from File** (or **Import from URL**).
...
- **Chat with Peers**: Add an HTTP Request Tool for natural language queries about peer representations. Read more in the [docs](https://docs.honcho.dev/v2.6.0-alpha/documentation/features/chat).

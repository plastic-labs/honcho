...
- **Peer Representation**: A working theory-of-mind model containing explicit observations (stated facts) and deductive observations (logical conclusions) about the peer
- **Peer Card**: Targeted context about what one peer knows about another
...
<Note>
For more details on all available parameters, see the [Get Context documentation](/v2/documentation/core-concepts/features/get-context).
</Note>

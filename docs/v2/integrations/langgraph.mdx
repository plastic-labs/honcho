...
<Note>
This example uses the honcho demo server. Found at https://demo.honcho.dev it runs a small instance of honcho on the latest version. If you need a production-ready setup get your Honcho API key at [app.honcho.dev](https://app.honcho.dev). For local development, use `environment="local"`.
</Note>
...
Define your chatbot logic, using Honcho for memory:

...
<Tabs>
    <Tab title="Honcho API">
        ...
        - Milvus vector store backend with Milvus Lite for single-process development, configurable Milvus Server or Zilliz Cloud connectivity for multi-process deployments, and session-consistent reads (#876)

...
<Tabs>
    <Tab title="Honcho API">
        ...
        - Reasoning levels configuration for dialectic (`low`, `medium`, `high`)
        - Streaming support for agentic dialectic responses
        ...
        - Pagination `this` binding in TypeScript SDK
    ...
    <Tab title="Python SDK">
        ...
        <Update label="v1.7.0 (Current)">
            ...
            - Now uses `honcho-core` dependency for API communication
    ...
    <Tab title="TypeScript SDK">
        ...
        <Update label="v1.7.0 (Current)">
            ...
            - Observations renamed to Conclusions across the SDK
            - Major SDK refactoring and cleanup
            - Now uses `@honcho-ai/core` dependency for API communication
            - Simplified method signatures throughout

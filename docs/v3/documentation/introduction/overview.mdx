---
title: "Honcho Overview: AI memory for agents"
icon: "brain"
sidebarTitle: "Overview"
description: "Honcho is open-source AI memory for agents: persistent, reasoning-based memory of users and other peers across sessions, tools and models."
---

    ...
    "messages": [
      {
        ...
        "session_id": "session-xyz",
        "peer_id": "user-123",
        "content_preview": "I just picked up some amazing dark roast from the place down the road...",
...
**Messages** carry an ID and the first 200 characters of the content, not the whole message. Fetch the message itself if you need the rest.

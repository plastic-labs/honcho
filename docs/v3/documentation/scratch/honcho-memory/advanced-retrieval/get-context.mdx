...
<CardGroup cols={3}>
  <Card title="Basic Get Context" icon="database" href="/v3/documentation/core-concepts/features/get-context">
    Learn about basic context retrieval
  </Card>
  <Card title="Summaries" icon="align-left" href="/v3/documentation/core-concepts/summarizer">
    Understand session summarization
  </Card>
  <Card title="Dialectic API" icon="comments" href="/v3/documentation/core-concepts/features/dialectic-endpoint">

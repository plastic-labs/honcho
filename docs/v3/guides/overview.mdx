...
<CardGroup cols={2}>
  ...
  <Card title="Claude Desktop" icon="star-of-life" href="/v3/guides/integrations/mcp">
    Let Claude manage its own memory in the native desktop app
  </Card>

...
sessions are. If you don't, start with [Core Concepts](/v3/documentation/core-concepts/architecture).
</Info>
...
them into a session. **How you bound that session is the main decision here**, because
...
([token batching](/v3/documentation/core-concepts/reasoning#token-batching)). Match the

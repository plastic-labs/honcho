...
This applies to OpenRouter (with non-Anthropic models), vLLM, Ollama, Google, and OpenAI providers. Only Anthropic models support the thinking budget parameter.

...
# Multi-tenant only: how often a claiming process re-reads which tenants have
# derivation paused (bounds pause-to-effect and resume-to-effect). No effect
# when MULTI_TENANT is off.
DERIVER_PAUSED_TENANTS_REFRESH_SECONDS=30

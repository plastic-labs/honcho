...
# Backup model (optional)
# SUMMARY_MODEL_CONFIG__FALLBACK__MODEL=claude-haiku-4-5
# SUMMARY_MODEL_CONFIG__FALLBACK__TRANSPORT=anthropic
...
# Backup model (optional)
# DREAM_MODEL_CONFIG__FALLBACK__MODEL=gemini-2.5-flash
# DREAM_MODEL_CONFIG__FALLBACK__TRANSPORT=gemini
